...
class BasicBlock(nn.Module):
    def __init__(self, in_chan, out_chan, stride=1):
        ...
        # self.conv3 = gOctaveConv(out_chan, out_chan)
...
class BA(nn.Module):
    ...
    def forward(self, low, high):
        ...
        upsampled_high = F.interpolate(refined_high, size=((refined_low.shape)[-2], (refined_low.shape)[-1]),
                                       mode='nearest')
...
class model(nn.Module):
    def __init__(self, channel):
        ...
        self.out = nn.Conv2d(19, 1, kernel_size=3, padding=1)
    ...
    def forward(self, x):
        ...
        out_final = self.decoder(block2=block2, block3=block3, block4=block4)
